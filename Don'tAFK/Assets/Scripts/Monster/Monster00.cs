...
public class Monster00 : MeleeMonster
{
    ...
    {
        m_MonsterMaxHP = 5 + (int)((MonsterSpawnManager.Stage * 1f) * (1 + MonsterSpawnManager.Stage * 0.05f));
        m_MonsterDamage = 1 + (int)((MonsterSpawnManager.Stage * 0.2f) * (1 + MonsterSpawnManager.Stage * 0.05f));
        m_MoveSpeed = 0.5f;
